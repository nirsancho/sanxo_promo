...
(function($){
    ...
    function dynamicPopup(){
        ...
        this.init = function(generalOptions, openOptions){
            ...
            if(typeof generalOptions === 'string'){
                settings.content = generalOptions;
            }
            ...
            if($popup.length == 0){
                ...
                $wrappers = {
                    ...
                    closeX:     $('<a></a>').attr({
                        ...
                        'data-icon': 'delete',
                        'data-iconpos': 'notext'
                    }).addClass('ui-btn-right closeX').html('Close').button(),
                    closeBtn:   $('<a></a>').attr({
                        'href': '#',
                        'data-inline': true,
                        'data-rel': 'back',
                        ...
                        'data-iconpos': 'right',
                        'data-theme': 'e'
                    }).addClass('closeBtn').html(settings.closeBtnLabel).button()
                };
        ...
        this.putPopupInDOM = function(){
            ...
            if (settings.closeXShow) {
                $wrappers.main.append($wrappers.closeX);
            }

            $wrappers.main.append($wrappers.content);

            if (settings.closeBtnShow) {
                $wrappers.main.append($wrappers.closeBtn);
            }
